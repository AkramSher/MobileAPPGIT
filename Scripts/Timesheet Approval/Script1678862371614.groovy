...
//Mobile.waitForElementPresent(findTestObject('Object Repository/Absence Request/android.widget.EditText'), 10)
...
Mobile.sendKeys(findTestObject('Object Repository/Absence Request/android.widget.EditText (1)'), '2023@24Lpa')
...
Mobile.tap(findTestObject('Approvals and self service/android.widget.TextView - APPROVALS'), 0)

Mobile.tap(findTestObject('TImesheetApproval/android.widget.TextView - TIME SHEET APPROVAL'), 0)

Mobile.tap(findTestObject('TImesheetApproval/android.widget.CheckBox'), 0)

Mobile.tap(findTestObject('TImesheetApproval/android.widget.Button - APPROVE'), 0)

Mobile.tap(findTestObject('TImesheetApproval/android.widget.Button - APPROVE (1)'), 0)

Mobile.tap(findTestObject('TImesheetApproval/android.widget.Button - YES'), 0)

Mobile.tap(findTestObject('TImesheetApproval/android.widget.Button - DONE'), 0)

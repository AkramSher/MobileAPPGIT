...
Mobile.waitForElementPresent(findTestObject('Object Repository/Absence Request/android.widget.TextView - TESTING'), 15)
...
Mobile.tap(findTestObject('Absence Request/android.widget.TextView - TIME'), 0)

Mobile.tap(findTestObject('TIME/android.widget.TextView - TIME SHEET'), 0)

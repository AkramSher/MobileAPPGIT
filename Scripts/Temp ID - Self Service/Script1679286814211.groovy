...
Mobile.startApplication('C:\\Users\\191060\\Downloads\\com.ust.uandust (1).apk', true)
...
Mobile.tap(findTestObject('Self Service/android.widget.TextView - SELF SERVICE'), 0)

Mobile.tap(findTestObject('Self Service/android.widget.TextView - REQUEST FOR TEMPORARY ID'), 0)

Mobile.tap(findTestObject('Self Service/android.widget.Button - APPLY'), 0)

Mobile.setText(findTestObject('Self Service/android.widget.EditText'), '9677492778', 0)

Mobile.tap(findTestObject('Self Service/android.widget.Button - Select Location'), 0)

Mobile.tap(findTestObject('Self Service/android.widget.Button - KOCHI'), 0)

Mobile.tap(findTestObject('Self Service/android.widget.Button - CHENNAI'), 0)

Mobile.tap(findTestObject('Self Service/android.widget.Button - OK'), 0)

Mobile.tap(findTestObject('Self Service/android.widget.Button - APPLY (1)'), 0)

Mobile.getText(findTestObject('Self Service/android.widget.TextView - A request already exists for today'), 0)

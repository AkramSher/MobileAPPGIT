...
Mobile.tap(findTestObject('PeopleFinder/android.widget.TextView - PEOPLE FINDER'), 0)

Mobile.sendKeys(findTestObject('PeopleFinder/android.widget.EditText - Employee ID'), '191060')

Mobile.tap(findTestObject('PeopleFinder/android.widget.Button - SEARCH'), 0)

Mobile.takeScreenshot('', FailureHandling.STOP_ON_FAILURE)

Mobile.getText(findTestObject('PeopleFinder/android.widget.TextView - Akramsheriff Akbarsheriff'), 0)

Mobile.tap(findTestObject('PeopleFinder/android.widget.TextView - Akramsheriff Akbarsheriff'), 0)

Mobile.getText(findTestObject('PeopleFinder/android.widget.TextView - rahulreddyAhmed'), 0)
